            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">                                  
                    <li class="nav-item dropdown">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(url('/imagens')); ?>"
                        class="nav-link px-2 text-white">Todas as imagens</a></li>
                        <li><a class="dropdown-item" href="<?php echo e(url('/imagens/create')); ?>" 
...
<?php /**PATH C:\xampp\htdocs\img_projeto\resources\views/layouts/main.blade.php ENDPATH**/ ?>